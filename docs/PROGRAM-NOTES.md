...
When one knee **hyperextends** and the other does not (common after ACL
reconstruction), the two legs reach different amounts of knee extension, so a bilateral hamstring
